...
public class BalanceScaleTraining {
    ...
    public static void main(String[] args) {
        ...
        Perceptron leftPerceptron = new Perceptron(4, 1);
        Perceptron balancePerceptron = new Perceptron(4, 1);
        Perceptron rightPerceptron = new Perceptron(4, 1);
