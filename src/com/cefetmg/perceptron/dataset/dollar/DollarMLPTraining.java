...
public class DollarMLPTraining {
    ...
    public static void execute() {
        ...
        MultiLayerPerceptron dollarPerceptron = new MultiLayerPerceptron(18, 50, 1);

        final double learningCoefficient = 0.0001d;
    ...
    public static ReadFileResult readAllDataSetFile() {
        try {
            InputStreamReader inputStreamReaderInputs = new InputStreamReader(new FileInputStream(new File("src/com/cefetmg/perceptron/dataset/dollar/files/entradas_dolar_dias_mod.txt")));
            BufferedReader bufferedReaderInputs = new BufferedReader(inputStreamReaderInputs);

            int trainingDataSetSize = 127;
            int testDataSetSize = 43;
            ...
            while ((line = bufferedReaderInputs.readLine()) != null) {
                ...
                List<Integer> ignoredColumns = Arrays.asList(0, 10);
